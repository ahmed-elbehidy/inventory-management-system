...
def product_form(window):
    ...
    update_button = Button(
        ...
        fg='white',
        bg='#0f4d7d',
        command= lambda :update_product(category_combobox.get(),supplier_combobox.get(),name_entry.get(),
                                    price_entry.get(),discount_spinbox.get(),quantity_entry.get(),status_combobox.get(),treeview)
    )
    ...
    search_button.grid(row=0, column=2, padx=(10,0),pady=20)
    ...
    treeview_frame.place(x=480,y=145,width=570,height=410)
